...
const Data = () => {
    return (
        <div className='home_data'>
            <h1 className='home_title'>Salut, <br></br> c'est Kimi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className='home_subtitle'>Développeur Front</h3>
            <p className='home_description'>Je suis un développeur front et UI/UX designer en 3e année de BUT MMI à l'université de Gustave Eiffel</p>
